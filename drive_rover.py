...
class RoverState():
    def __init__(self):
        ...
        self.avoid_angle = 0 # send a deviated avoid angle towards explored terrian
        self.lastpos = None # save last position
        self.counter = 0 # evaluate stuckness every 10 frames
        self.cumdist = 0 # cumulative distance per 10 frames
        self.sample_in_view = False # whether sample is detected in vision
        self.sample_thresh = 10 # minimal sample pixels
        self.rock_dists = None
        self.rock_angles = None
        self.laststeer = 0 # save the last steering angle (updated in supporting_functions)
        self.cumsteer = 0 # save the cumulative steering angle
